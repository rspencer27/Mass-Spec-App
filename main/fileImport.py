	...
	def get_peptoid_names(self):
		...
		while True:
			try:
				...
				peptoid_names = ['Nab', 'Nae', 'Nbsa', 'Nbn', 'Namd', 'Nce', 'Ncm', 'Ncp', 'Ncpr', 'Ndpe','Nfu','Nhe','Nia','Nme','Nmp','Nbu','Npe','Npip','Npp','Ntrp','Ntyr','Nipr','Nph','Nspe','Nime','Npyr', 'Nte','Ndc','Ncpe']
				break
