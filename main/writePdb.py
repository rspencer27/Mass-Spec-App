		...
		for q in range(0,number_of_rings):
			...
			for p in range (0, repeats):
				...
				if p%2 == 0:
					...
					rotation_y = -math.sin(((60+(p-1)*30)*math.pi)/180)*9 - math.cos(((0+(p-1)*30)*math.pi)/180)*9
					rotation_x = -math.cos(((60+(p-1)*30)*math.pi)/180)*9 + math.sin(((0+(p-1)*30)*math.pi)/180)*9
